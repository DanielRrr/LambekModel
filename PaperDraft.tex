...
\begin{defin}
  ...
  \begin{enumerate}
    ...
    \item $\mathcal{M}, w \Vdash A \lor B \Leftrightarrow \forall u, v \in W, R(u,v,w) \text{ either } \mathcal{W}, u \Vdash A \text{ or } \mathcal{W}, v \Vdash B$;
...
\begin{defin}
  Mininal normal modal Lambek calculus is $L^{*}_{\bf 1} \land \lor$ with additional rule:

...
\begin{theorem}
  ...
  quantic conucleus. Then $\mathfrak{Q}$ is isomorphic to relational quantale on $Q$ with some quantic conucleus.
\end{theorem}
...
\begin{proof}
  ...
  It is clear that, $I(a) \leq a$. So $I(a) \leq \bigvee \{ s \in \mathcal{Q}_{I} \: | \: s \leq a \} = I'(a)$.

  Thus, we showed that $I(a) = I'(a)$. One need to apply the previous theorem with $I'$.
\end{proof}

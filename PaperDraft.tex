...
\begin{itemize}
Let us show that $\mathcal{Q} \models !A \rightarrow A$.

Let $\mathcal{Q} \models !A$ and $v$ be a valuation, hence $\langle a, b \rangle \Vdash !A$.
Hence there exists $S_{\langle a, b \rangle} \subseteq \mathcal{Q}$,
such that $\forall \langle a', b' \rangle \in S_{\langle a, b \rangle}, \langle a', b' \rangle \models A$,
but $\langle a, b \rangle \in S_{\langle a, b \rangle}$, so $\langle a, b \rangle \models A$.

\item Let us show that $\mathcal{Q} \models !A \rightarrow !!A$.

Let $\langle a, b \rangle \models !A$. Let us show that $\langle a, b \rangle \models !!A$.
...
$ $
  ...
  Let $\mathcal{Q}$ be a relational quantale, then $Log(\mathcal{Q}) = L^{*}(\backslash, /, \bullet, {\bf 1}, \&, \vee)$.
\end{theorem}
